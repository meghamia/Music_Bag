...
import 'package:demo/binding/liked_screen_%20binding.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      initialBinding: BindingsBuilder(() {
        ...
        // Get.put(SongPlayerController()); // Add this line
      }),
      getPages: [
        ...
        GetPage(
            name: '/songPlayPage',
            page: () => SongPlayPage(),
            binding: SongPlayPageBinding()),
        GetPage(
            name: '/homePage',
            page: () => HomePage(),
            binding: HomePageBinding()),

        //  GetPage(name: '/likeScreen', page: () => LikedSongPage(),binding: LikedPageBinding()),
      ],
    );
  }
}
